...
function createScene(shader){
    ...
    var directional = new DirectionalLight("Test",0.7,0.3,[0,1,1],[1,1,1])

    DirectionalLight.bindLights(shader)
    DirectionalLight.loadLights(shader)
    var aaa = new sceneNode(new Drawable(Transformations.gimbalT.XYZ,shapeCrate))
